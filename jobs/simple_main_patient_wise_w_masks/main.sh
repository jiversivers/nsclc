...
#SBATCH --job-name=nsclc_main_masked_pt
...
rsync -avq $SLURM_SUBMIT_DIR/simple_main_patient_wise_w_masks.py /scratch/$SLURM_JOB_ID
...
python3 simple_main_patient_wise_w_masks.py
