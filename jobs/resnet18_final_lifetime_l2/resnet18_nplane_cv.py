...
def main():
    ...
    data = NSCLCDataset('NSCLC_Data_for_ML', ['taumean', 'boundfraction'], device='cpu',
    ...
    batch_size = 64
    lr = 1e-5
    optimizer_fn = [torch.optim.Adam, {'weight_decay': 0.01}]
    total_epochs = 1000
    ...
    for fold in range(num_folds):
        ...
        optimizer = optimizer_fn[0](model.parameters(), lr=lr, **optimizer_fn[1])
