...
#SBATCH --job-name=simple_cnns_with_all_no_mask.py
...
rsync -avq $SLURM_SUBMIT_DIR/simple_cnns_with_all_no_mask.py /scratch/$SLURM_JOB_ID
...
python3 simple_cnns_with_all_no_mask.py
