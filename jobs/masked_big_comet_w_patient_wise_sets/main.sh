...
#SBATCH --job-name=big-comet_masked_iterator
...
rsync -avq $SLURM_SUBMIT_DIR/masked_big_comet_w_patient_wise_sets.py /scratch/$SLURM_JOB_ID
...
python3 masked_big_comet_w_patient_wise_sets.py
