...
#SBATCH --job-name=image_hp_iterator
...
rsync -avq /home/jdivers/nsclc/jobs/image_model_folded_hp_iterator.py /scratch/$SLURM_JOB_ID
...
python3 image_model_folded_hp_iterator.py
