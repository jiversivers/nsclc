...
def main():
    ...
    train_data = NSCLCDataset('NSCLC_Data_for_ML', ['fad', 'nadh', 'shg'], device=torch.device('cpu'),
    ...
    eval_test_data = NSCLCDataset('NSCLC_Data_for_ML', ['fad', 'nadh', 'shg'], device=torch.device('cpu'),
                                  label='Metastases', mask_on=True)
